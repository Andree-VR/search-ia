...
public class UsuarioDAO implements CRUDUsuario, ValidarUsuario{
   ...
   @Override
    ...
    public boolean add(Usuario usu) {
       String sql="insert into login(nombre, apellido, usuario, clave) values('"+usu.getNombre()+"','"+usu.getApellido()+"','"+usu.getUsuario()+"','"+usu.getPassword()+"','"+usu.getEmail()+"')";
        try {
            con=cn.getConnection();
            ps=con.prepareStatement(sql);
            ps.executeUpdate();
    ...
    public boolean edit(Usuario usu) {
        String sql="update login set usuario='"+usu.getNombre()+"', apellido='"+usu.getApellido()+", usuario='"+usu.getUsuario()+"', clave='"+usu.getPassword()+"', email='"+usu.getEmail()+"'";
        try {
            con=cn.getConnection();
            ps=con.prepareStatement(sql);
            ps.executeUpdate();
